<section class="space-y-6">
    ...
    <x-modal name="confirm-delete-product" focusable>
        <form method="post" action="{{ route('products.destroy', $product) }}" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">{{ __('Are you sure you want to delete this product?') }}</h2>
            ...
            <div class="flex justify-end mt-6">
                ...
                <x-danger-button class="ms-3"> {{ __('Delete Product') }} </x-danger-button>
            </div>
        </form>
    </x-modal>
</section>
